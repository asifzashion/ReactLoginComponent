...
const LoginWebMethodsCloud = ({ onLogin, logo,logoStyle }) => {
  ...
  return (
    ...
    <h2 className='border-bottom m0 p-3 card-title'>Login Web Methods Cloud</h2>
...
LoginWebMethodsCloud.propTypes = {
  onLogin: PropTypes.func.isRequired,
};

export default LoginWebMethodsCloud;